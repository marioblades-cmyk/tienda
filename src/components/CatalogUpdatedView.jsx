    ...
    const handleCreateItem = async () => {
        ...
        try {
            ...
            const payload = {
                ...
                precio_tapa: f.precio_tapa ? parseFloat(f.precio_tapa) : 0,
                precio_venta_bs: f.precio_venta_bs ? parseFloat(f.precio_venta_bs) : 0,
                precio_n2_bs: f.precio_n2_bs ? parseFloat(f.precio_n2_bs) : 0,
                precio_n3_bs: f.precio_n3_bs ? parseFloat(f.precio_n3_bs) : 0,
                precio_mayoreo_bs: f.precio_mayoreo_bs ? parseFloat(f.precio_mayoreo_bs) : 0,
