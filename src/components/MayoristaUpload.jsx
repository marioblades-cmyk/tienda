                                    ...
                                    <div className="p-6 flex flex-col md:flex-row justify-between items-center gap-6">
                                        <div className="flex items-center gap-4 flex-1">
                                            ...
                                            <div>
                                                ...
                                                <p className="text-[10px] text-slate-400 font-black uppercase tracking-widest">{new Date(pedido.created_at).toLocaleDateString()} • {pedido.items.filter(it => !(it.estado?.includes('RECORTADO') || ['CANCELADO','DESPACHADO','ENTREGADO'].includes(it.estado))).reduce((s, it) => s + (it.cantidad || 0), 0)} libros a enviar</p>
                                            </div>
                                        </div>
