...
export default function AdminConsolidatedView({ sellerIdFilter = null }) {
    ...
    const exportWholesaleCatalog = async () => {
        ...
        try {
            ...
            // 2. Generar el Excel con el motor compartido (mismo que usa la simulación
            //    de Análisis de Precios). Sin ajustes manuales: comportamiento igual al de siempre.
            await catalogService.generateWholesaleWorkbook(semana, settings.pricing, {});
